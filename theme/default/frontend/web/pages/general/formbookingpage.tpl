...
<div class="box-search-ticket">
  <div class="wrapper">
    ...
    <div class="form-search-ticket">
      <form action="{$server_url}/booking/step1" method="post" name="formSearchTicket" id="formSearchTicket" onSubmit="return vnTFormSearch.doCheckSearch(this);">
...
<script type="text/javascript" src="{$theme_dir}/js/SearchForm.js"></script>{literal}
