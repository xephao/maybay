<form name="formBooking" method="post" action="{$server_url}/booking/step3" id="formBooking" role="form" class="validate" novalidate="novalidate">
                ...
                <div class="rowInputLeft">
                  <div class="rowInputTable">
                    ...
                    <div class="rowInputGroup">
                      ...
                      </div>{include file="frontend/web/pages/booking/modsidebar.tpl"}
                      <div class="clear"></div>
                    </div>
                  </form>
                </div>
