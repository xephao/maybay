							...
							<div class="group-fitter">
								...
								<div class="group_content">
									<div class="label_flight">
										...
										<div class="fr"><div class="lable_img"><img src="{$theme_dir}/images/smBL.gif" alt=""></div></div>
										<div class="clear"></div>
									...
									<div class="fr"><div class="lable_img"><img src="{$theme_dir}/images/smVJ.gif" alt=""></div></div>
									<div class="clear"></div>
								...
								<div class="fr"><div class="lable_img"><img src="{$theme_dir}/images/smVN.gif" alt=""></div></div>
								<div class="clear"></div>
							</li></ul>
