...
<div class="mod_info_custumer">
  <div class="mod_main">
    <form action="{$server_url}/booking/step4" method="post" name="f_checkout" id="f_checkout" onsubmit="return vnTBooking.processCheckoutMethod();">
      ...
      <div class="method_pay_content" style="display: none;">
        <div class="pay_bank">
          <div class="pay_bank_title">
            <div class="pay_bank_lTitle ">1. <span style="margin-right:10px;"><img src="{$theme_dir}/images/logoeximbank.jpg" alt="Ngân hàng thương mại xuất nhập khẩu Việt Nam - EXIMBANK" width="80"></span>Ngân hàng thương mại xuất nhập khẩu Việt Nam - EXIMBANK</div>
        ...
        <div class="pay_bank">
          <div class="pay_bank_title">
            <div class="pay_bank_lTitle ">2. <span style="margin-right:10px;"><img src="{$theme_dir}/images/sacombank.jpg" alt="Ngân hàng Sacombank" width="80"></span>Ngân hàng Sacombank</div>
            <div class="pay_bank_rTitle">
...
{include file="frontend/web/pages/booking/modsidebar.tpl"}
...
<script type="text/javascript" src="{$theme_dir}/js/booking.js"></script>
