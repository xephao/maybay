...
// device detection
    ...
    if(isMobile == false){
        $("body").lazyScrollLoading({
            lazyItemSelector : ".lazyloading ,.w_effect_up",
        ...
        $(".lazyloading, .w_effect_up").addClass("show");
    }
 $('#slider_new2').slick({
        slidesToShow:2,
        slidesToScroll: 2,
    ...
    $(".gird_method .item:first").addClass("active");
    $(".gird_method .item .i-icon").click(function(){
        $(this).parents(".item").addClass("active");
        $(this).parents(".item").siblings().removeClass("active");
    });

    if($(window).innerWidth() <= 1024){
        $(".gird_method .item .w-item").removeClass("effect_up");
    }
    $(window).resize(function(){
        ...
        if($(window).innerWidth() <= 1024){
            ...
            $(".gird_method .item .w-item").addClass("effect_up");
        }
    });
