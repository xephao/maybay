...
$smarty         =   $cl_helper->init_smarty('../maybay/theme/default/','../maybay/compile/');
// $smarty         =   $cl_helper->init_smarty('../app/theme/default/','../app/compile/');
...
$seolink = "";
   ...
   $cur_mod = $_GET['mod'];
    ...
    include_once(dirname(__FILE__)."/frontend/index.php"); 
    if (isset($_POST['search'])) {
        include_once(dirname(__FILE__)."/frontend/search_form.php"); 
    }
...
if($browser_type == 'web')
{
	$smarty->display('frontend/'.$browser_type.'/index.tpl');
}
